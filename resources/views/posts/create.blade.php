        ...
        <div class="col-md-12">
            ...
            <form action="{{route('posts.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm {{($errors->has('title'))?'is-invalid':''}}" name="title" value="{{old('title')}}">
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm {{($errors->has('description'))?'is-invalid':''}}" name="description" value="{{old('description')}}">
